...
int main(int argc, char* argv[]){
    ...
    Quaternion q(-0.03820764984813447, -0.9515795634978994, 0.1448833656868248, -0.26841259317231625); //wxyz
    // set cart pose
    Eigen::Vector3d pos(0.5882000000000001, 0.020010000000000003, 0.74138); // in m
